...
export function DetailPage(props) {
    ...
    return (
        <div>
            ...
            <ActionDecision context={props.context} itemsAD={props.itemsAD} setItemsAD={props.setItemsAD} idItemAD={props.idItemAD} setIdItemAD={props.setIdItemAD} setScreen={props.setScreen}/>
        </div>
    )
}